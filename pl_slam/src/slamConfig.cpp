    ...
    : Config()
{
    ...
    // Loop closure
    vocabulary_p          = "/media/zhijian/Document/grow/slam/PL_SLAM/pl_slam/vocabulary/mapir_orb.yml";
    vocabulary_l          = "/media/zhijian/Document/grow/slam/PL_SLAM/pl_slam/vocabulary/mapir_lsd.yml";
